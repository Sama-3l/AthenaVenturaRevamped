  ...
  return (
    <div className='flex flex-col'>
        <div className='bg-(--color-foreground) md:h-svh'>
          ...
          <div className='py-8 px-4 md:px-12 flex flex-rol justify-between'>
          ...
          <div className='px-4 md:px-12 pb-6 justify-items-start md:justify-items-center align-middle'>
            <p className={`font-normal sm:wd-90 tracking-[-0.5%] ${styles.body_text}`}>
          ...
          <div className='relative px-4 md:px-12 pb-12 flex flex-col md:flex-row justify-start md:justify-between md:items-end items-start overflow-hidden'>
            <div className='absolute w-full h-[90%] md:w-1/2'>
              <ThrowingPhotos photo1='/Siddhartha_1.png' photo2='/Rishi_1.png' />
            </div>
            <p className={`font-normal pb-12 md:pb-0 sm:wd-90 tracking-[-0.5%] ${styles.body_text}`}>
